...
import { FileText, Sparkles, Target, Zap, Shield, ChevronRight, CheckCircle2, ArrowRight } from 'lucide-react';
    ...
    <div className="min-h-screen bg-background text-foreground selection:bg-primary/20 overflow-hidden relative font-sans">
      ...
      <nav className="fixed top-0 inset-x-0 h-16 border-b border-border bg-background/80 backdrop-blur-md z-50">
        <div className="max-w-7xl mx-auto px-6 h-full flex items-center justify-between">
          <div className="flex items-center gap-2 group">
            ...
            <span className="text-xl font-bold tracking-tight text-heading">HireCraft AI</span>
          </div>
      ...
      <main className="pt-32 pb-16 px-6">
        ...
        <section className="max-w-7xl mx-auto text-center space-y-10 relative z-10">
          ...
          <p className="max-w-3xl mx-auto text-xl md:text-2xl text-muted-foreground font-medium tracking-tight animate-in fade-in slide-in-from-bottom-8 duration-700 delay-200">
            Build professional, ATS-optimized resumes in minutes. Our AI analyzes job descriptions and tailors your experience to beat the bots and impress recruiters.
          </p>
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 pt-4 animate-in fade-in slide-in-from-bottom-10 duration-700 delay-300">
            <Link href="/signup">
              <Button size="lg" className="h-14 px-8 text-base bg-primary hover:bg-primary/90 text-primary-foreground rounded-full shadow-md hover:shadow-lg transition-all group">
                Build Resume Free
                <ArrowRight className="ml-2 h-5 w-5 group-hover:translate-x-1 transition-transform" />
              </Button>
            </Link>
            <Link href="#features">
              <Button size="lg" variant="outline" className="h-14 px-8 text-base border-border text-foreground hover:bg-accent hover:text-accent-foreground rounded-full bg-background">
                See How It Works
              </Button>
            </Link>
          </div>
          ...
          <div className="pt-10 flex items-center justify-center gap-8 text-muted-foreground text-sm font-medium animate-in fade-in duration-1000 delay-500">
            ...
            <div className="flex items-center gap-2"><CheckCircle2 className="h-4 w-4 text-success" /> Free PDF downloads</div>
            <div className="flex items-center gap-2"><CheckCircle2 className="h-4 w-4 text-success" /> AI content rewriting</div>
          </div>
        </section>
        ...
        {/* Features Bento Grid */}
        <section id="features" className="max-w-7xl mx-auto mt-40 relative z-10">
          <div className="text-center mb-20 space-y-6">
            <h2 className="text-4xl md:text-6xl font-extrabold text-heading tracking-tight drop-shadow-sm">Supercharge your job search</h2>
            <p className="text-muted-foreground text-xl md:text-2xl font-medium max-w-3xl mx-auto">Everything you need to stand out from the crowd, all in one powerful platform powered by cutting-edge AI.</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="col-span-1 md:col-span-2 row-span-2 rounded-3xl bg-card border border-border shadow-sm p-8 flex flex-col justify-between relative overflow-hidden group hover:border-primary/50 transition-colors">
              ...
              <div className="space-y-6 relative z-10">
                ...
                <div className="space-y-2">
                  <h3 className="text-2xl font-bold text-heading">AI Content Generation</h3>
                  <p className="text-muted-foreground leading-relaxed max-w-md">Struggling with writer's block? Our AI analyzes your role and generates professional summaries and bullet points that highlight your impact and achievements.</p>
                </div>
              </div>
            </div>
            ...
            <div className="col-span-1 rounded-3xl bg-card border border-border shadow-sm p-8 relative overflow-hidden group hover:border-primary/50 transition-colors">
               ...
               <div className="space-y-6 relative z-10">
                ...
                <div className="space-y-2">
                  <h3 className="text-xl font-bold text-heading">ATS Job Matcher</h3>
                  <p className="text-sm text-muted-foreground leading-relaxed">Paste a job description and instantly see your match score. Find missing keywords to beat applicant tracking systems.</p>
                </div>
              </div>
            </div>
            ...
            <div className="col-span-1 rounded-3xl bg-card border border-border shadow-sm p-8 relative overflow-hidden group hover:border-primary/50 transition-colors">
              <div className="absolute top-0 left-0 w-32 h-32 bg-success/5 blur-[50px] group-hover:bg-success/10 transition-colors" />
               <div className="space-y-6 relative z-10">
                ...
                <div className="space-y-2">
                  <h3 className="text-xl font-bold text-heading">Data Privacy</h3>
                  <p className="text-sm text-muted-foreground leading-relaxed">Your data is yours. We use enterprise-grade encryption and never sell your personal information to third parties.</p>
                </div>
              </div>
            </div>
            ...
            {/* Feature 4 */}
             <div className="col-span-1 md:col-span-3 rounded-3xl bg-muted/50 border border-border shadow-sm p-8 sm:p-12 flex flex-col md:flex-row items-center justify-between gap-8 group hover:border-primary/30 transition-colors">
                <div className="space-y-4 max-w-xl">
                  ...
                  <h3 className="text-2xl sm:text-3xl font-bold text-heading">Cover Letters in 1-Click</h3>
                  <p className="text-muted-foreground">Generate highly tailored cover letters that perfectly align your resume with the target job description. Save hours of writing and stand out instantly.</p>
                </div>
                <Link href="/signup">
        ...
        <section className="max-w-5xl mx-auto mt-40 text-center relative z-10 mb-20 py-16 bg-white rounded-[3rem] border border-border/50 shadow-2xl">
           ...
           <h2 className="text-4xl md:text-[4rem] font-black tracking-tight text-heading mb-8">Ready to land your next role?</h2>
           <p className="text-2xl text-muted-foreground mb-12 font-medium max-w-2xl mx-auto">Join thousands of job seekers who use HireCraft AI to get hired faster.</p>
           <Link href="/signup">
              <Button size="lg" className="h-14 px-10 text-base bg-primary text-primary-foreground hover:bg-primary/90 rounded-full shadow-lg hover:scale-105 transition-all">
      ...
      <footer className="border-t border-border bg-muted/30 relative z-10">
        <div className="max-w-7xl mx-auto px-6 py-12 flex flex-col md:flex-row items-center justify-between gap-6">
          ...
          <p className="text-sm text-muted-foreground">© {new Date().getFullYear()} HireCraft AI. All rights reserved.</p>
        </div>
      </footer>
    </div>
  );
