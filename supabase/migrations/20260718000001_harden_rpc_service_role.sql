-- Supabase Migration: Harden RPC Service Role Access
-- Migration ID: 20260718000001_harden_rpc_service_role
...
BEGIN
    ...
    IF (auth.role() != 'service_role') AND (user_id_val IS NULL OR user_id_val != auth.uid()) THEN
